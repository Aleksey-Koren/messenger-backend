...
public class FileServiceImpl implements FileService {
    ...
    public FileServiceImpl(@Value("#{messageProperties.pathToAttachmentsFolder}") String PATH_TO_ATTACHMENTS) {
    ...
    private void deleteAllFiles(Path directory) {
        if (Files.isDirectory(directory)) {
            ...
            log.warn("Retrieved pass {} doesn't point on directory. It isn't directory, or it doesn't exist",
                    absoluteToRelativePath(directory));
        }
    }
    ...
    private boolean isEmpty(Path directory) {
        try (Stream<Path> files = Files.list(directory)) {
            ...
            log.warn("Pass {} doesn't point on directory. It isn't directory, or it doesn't exist",
                    absoluteToRelativePath(directory));
            return true;
        }
    }
